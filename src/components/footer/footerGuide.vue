<template>
  <section id="footer-guide">
    ...
    <section @click = "gotoAddress({path: '/msite', query: {geohash:geohash}})" class="item">
    ...
    <section @click="gotoAddress('/search/'+geohash)" class="item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <section @click="gotoAddress('/order')" class="item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <section @click="gotoAddress('/profile')" class="item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
